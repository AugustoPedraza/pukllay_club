...
| 005 | detail-page | What does the full game detail page (`/juegos/:id`) look like inside the shell — hero, facts, description, mechanics? | B (card-consistent masthead, refined w/ info accordion, share, WhatsApp reservation CTA) | layout, detail, card, accordion, share, whatsapp |
