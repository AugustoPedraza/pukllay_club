...
|---|------|----------------|--------|------|
| 017 | header-composition | With 013/014/015 decided (E / D-refined / A), does the full header row still feel overloaded, is a row-based structure even right, and should the CTA/theme-toggle live in the header at all? Covers mobile+desktop together. | *(pending review)* | header, composition, search, navigation, mobile, information-architecture, cta-placement, footer |
