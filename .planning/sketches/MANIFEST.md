...
| 008 | filter-search-ui | What does the catalog's own filter surface look like, and how should the nav search box's live-narrowing/typeahead behave? | *(in progress — Round 8, icon-free rebalanced Airbnb-style filter modal)* | filter, search, navigation, information-architecture |
