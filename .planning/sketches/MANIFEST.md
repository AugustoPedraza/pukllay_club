...
| 011 | full-shell-composition | Does the real shell hold together once it wraps the real detail page (005-B) and about page (004-B) instead of 007's placeholder skeletons? | single composed view — consistency check, found+fixed 6 real drift bugs (see README) + a second round of 8 real mobile bugs found via user testing at ≤480px (nav drawer/search/filters, isologo, footer, about-page index, sticky-chrome regressions) | consistency, layout, detail, about, shell, mobile |
